...
<body>
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="admin_orders.php"><i class="fas fa-shopping-cart" style="margin-right: 10px;"></i> Đơn đặt hàng</a></li>
      ...
      <li><a href="profile.php"><i class="fas fa-user" style="margin-right: 10px;"></i> Cài đặt hồ sơ</a></li>
      ...
      <form id="addUserForm" method="POST" action="add_staffs.php">
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="role" class="label">Vai trò</label>
          </div>
        </div>
      ...
      <form id="editUserForm" method="POST" action="edit_staffs.php">
        ...
        <div class="modal-content">
          ...
          <div class="input-group" style="padding-bottom: 20px;">
            ...
            <label for="editRole" class="label">Vai trò</label>
          </div>
