...
<body>
    ...
    <div class="content">
        ...
        <div class="modal-row">
            <div>
                ...
                <button onclick="openItemModal()"> <i class="fas fa-plus"></i> &nbsp;Thêm sản phẩm mới</button>
        ...
        <table id="menuTable">
            ...
            <tbody>
                ...
                <td>
                    ...
                    echo "<tr><td colspan='8' style='text-align: center;'>Không tìm thấy sản phẩm nào</td></tr>";
                }
                ?>
        ...
        <div class="modal-container">
            <form class="form" method="POST" action="add_category.php">
                ...
                <div class="modal-footer">
                    <button type="button" class="button" onclick="closeModal()">Hủy bỏ</button>
            ...
            <form class="form" method="POST" action="add_item.php" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="input-group">
                        ...
                        <label for="itemName" class="label">Tên sản phẩm</label>
                    </div>
                    <div class="input-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="button" onclick="closeItemModal()">Hủy bỏ</button>
                    <button type="submit" class="button">Lưu</button>
                </div>
            </form>
        </div>
            ...
            <form class="form" method="POST" action="edit_item.php" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="input-group">
                        ...
                        <label for="editItemName" class="label">Tên sản phẩm</label>
                    </div>
                    <div class="input-group">
                        <input type="text" name="description" id="editDescription" class="input" required>
                        <label for="editDescription" class="label">Mô tả</label>
                    </div>
                    <div class="input-group">
                        ...
                        <label for="editStatus" class="label">Trạng thái</label>
                    </div>
                    <div class="input-group">
                        <input type="number" name="price" id="editPrice" class="input" required>
                        <label for="editPrice" class="label">Giá</label>
                    </div>
                    <div class="input-group">
                        ...
                        <label for="editCatName" class="label">Danh mục</label>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="button" onclick="closeEditItemModal()">Hủy bỏ</button>
                    <button type="submit" class="button">Lưu</button>
                </div>
            </form>
        </div>
    ...
    <div class="modal" id="viewCategoryModal">
        ...
        <div class="modal-container" style="background: #fef0e8;">
                    ...
                    <table id="categoryTable" style="width:100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<tr><td colspan='2'>Không tìm thấy danh mục nào</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
            ...
            <div class="modal-footer" style="border-top: 1px solid #ffc9b3">
                <button type="button" class="button" onclick="closeViewCategoryModal()">Đóng</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function deleteCategory(catName) {
            if (confirm(`Bạn có chắc chắn muốn xóa danh mục: ${catName}?`)) {
                // Thực hiện yêu cầu AJAX để xóa danh mục khỏi cơ sở dữ liệu
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 200) {
                            ...
                            // Tải lại nội dung modal hoặc xóa hàng khỏi bảng
                            location.reload(); // Tải lại trang để phản ánh những thay đổi
                        } else {
                            alert("Xóa danh mục thất bại. Hãy thử lại.");
                        }
                    }
                };
    ...
    <script>
        function togglePopular(itemId, checkbox) {
            ...
            // gửi dữ liệu theo kiểu key=value như form html
            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    ...
    <script>
        ...
        function openEditItemModal(button) {
            // Lấy thông tin chi tiết về mục từ các thuộc tính dữ liệu
            ...
            // Thiết lập các trường phương thức
    ...
    <script>
        // Quay lại chức năng nút đầu trang
