...
<body>
  ...
  <div class="content">
    <div class="header">
      ...
      <h2><i class="fas fa-star"></i> Các đánh giá của khách hàng</h2>
    </div>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<tr>
                        ...
                        <td>
                         ...
                         <option value='Đang chờ xử lý' " . ($row['status'] == 'Đang chờ xử lý' ? 'selected' : '') . ">Đang chờ xử lý</option>
                         <option value='Đã chấp nhận' " . ($row['status'] == 'Đã chấp nhận' ? 'selected' : '') . ">Đã chấp nhận</option>
                         <option value='Bị từ chối' " . ($row['status'] == 'Bị từ chối' ? 'selected' : '') . ">Bị từ chối</option>
                         </select>
                        </td>
      ...
      <form id="editReviewForm" method="POST" action="edit_review.php">
        ...
        <div class="modal-content">
          <div class="input-group">
            ...
            <label for="editReview_text" class="label">Đánh giá văn bản</label>
          </div>
        </div>
        <div class="modal-content">
          <div class="input-group">
        ...
        <div class="modal-footer">
          <button type="button" class="button" onclick="closeEditReviewModal()">Hủy bỏ</button>
