...
if (empty($useremail)) {
  die("Không tìm thấy email người dùng trong phiên làm việc.");
}
  ...
  <div>
    <nav class="navbar navbar-expand-md fixed-top">
      <div class="container-fluid nav-container">
        <a class="navbar-brand me-auto logo" href="index.php">Nhà hàng Steakout</a>
            ...
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a class="dropdown-item" href="menu.php#mon-khai-vi">Món khai vị</a></li>
                  <li><a class="dropdown-item" href="menu.php#mon-chinh">Món chính</a></li>
                  <li><a class="dropdown-item" href="menu.php#mon-trang-mieng">Món tráng miệng</a></li>
                  <li><a class="dropdown-item" href="menu.php#do-uong">Đồ uống</a></li>
                </ul>
              </li>
              <li class="nav-item">
        ...
        <!-- Biểu tượng hồ sơ với menu thả xuống -->
        <li class="nav-item dropdown ms-3" style="list-style: none; ">
          ...
          <ul class="dropdown-menu" aria-labelledby="profileDropdown" style="margin-left: -50px;">
            <li><a class="dropdown-item" href="profile.php"><i class="fas fa-user-circle dropdown-icon"></i> Hồ sơ</a></li>
            <li><a class="dropdown-item" href="orders.php"><i class="fas fa-box dropdown-icon"></i> Đơn đặt hàng</a></li>
            <li><a class="dropdown-item" href="logout.php"><i class="fas fa-sign-out-alt dropdown-icon"></i> Đăng xuất</a></li>
          </ul>
        </li>
